...
1. What is it? (Proper definition)
...
2. Why should we use it? (What problems does it solve?)
...
3. When and where to use it (Purpose)
...
7. What changes does it make in the program?
